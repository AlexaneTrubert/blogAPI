...
cur.execute("CREATE TABLE comments (article_id INT, name VARCHAR(16), comment VARCHAR(255) NOT NULL, ts INT, CONSTRAINT `fk_article_id` FOREIGN KEY(`article_id`) REFERENCES `article`(`id`))")
